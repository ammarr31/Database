...
SELECT job_id, MAX(salary) , MIN(salary) min_salary FROM employees GROUP BY job_id;
...
SELECT department_id, AVG(salary) , COUNT(*)  FROM employees GROUP BY department_id HAVING AVG(salary) > 8000 AND COUNT(*) < 10;
